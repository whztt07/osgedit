#ifndef __POSITION_CONTROL_3D_H__
#define __POSITION_CONTROL_3D_H__
 ...
 */
class PositionControl3D: public Control3D,
...
private:
	...
	osg::Vec3 _posSource; ///< Position when the drag begins
	...
	osg::ref_ptr<Vec4fProperty> _target4; ///< Property being controlled by this 3D control
	osg::ref_ptr<MatrixdProperty> _targetM; ///< Property being controlled by this 3D control
};

#endif//__POSITION_CONTROL_3D_H__
